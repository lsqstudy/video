package com.lsqstudy.common.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.lsqstudy.system.realm.AdministratorRealm;
import lombok.Data;
...
public class ShiroAutoConfiguration {
	...
	/**
	 * 声明AdministratorRealm
	 */
	@Bean("administratorRealm")
	public AdministratorRealm userRealm(CredentialsMatcher credentialsMatcher) {
		AdministratorRealm administratorRealm = new AdministratorRealm();
		// 注入凭证匹配器
		administratorRealm.setCredentialsMatcher(credentialsMatcher);
	...
	public SecurityManager securityManager(AdministratorRealm administratorRealm) {

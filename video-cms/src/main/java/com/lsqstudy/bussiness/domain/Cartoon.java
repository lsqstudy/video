package com.lsqstudy.bussiness.domain;
...
public class Cartoon {
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")//@DateTimeFormat的使用和@jsonFormat差不多
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @Field("create_time")

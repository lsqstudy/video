...
public class ZXingCodeEncodeUtils {
		...
		try {
			...
			if (null != codeNormal) {
				...
				if (null != logoStream) {
					...
					/**
					 * logoImage logo图片对象 x 开始画的x轴坐标 y 开始画的y轴的坐 logo_width
					 * 要画的x轴的长度 logo_height 要画的y车的长度 arg5 null
					 */
	...
	public static void main(String[] args) {
		// createZXingCodeSaveToDisk("aa", 400, 400, "D:/laolei.gif", "JPEG");
		String url = "http://106.14.139.161:8900/temp/2020/03/10/1583811985470610.jpg";
		InputStream logoStream = null;
	    logoStream = getImageStream(url);

		// logoStream=ZXingCodeEncodeUtils.class.getClassLoader().getResourceAsStream("logo.jpg");
		createZxingCodeUseLogoSaveToDisk("https://www.baidu.com/", 400, 400, "D:/laolei.gif", "JPEG", logoStream);
